      ...
      <div className="mt-2">
        <div className="space-y-2">
          {files.map((file, index) => (
            <ul key={index} className="flex justify-between items-center  pl-2">
              <li className="flex justify-between items-center w-full">
                <span
                  onClick={() => window.open(file.url, "_blank")}
                  className="text-blue-400 cursor-pointer truncate w-[150px] overflow-hidden text-ellipsis hover:font-semibold"
