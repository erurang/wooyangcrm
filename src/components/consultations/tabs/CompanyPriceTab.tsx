    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="text-sm text-gray-600">
          총 <span className="font-semibold text-blue-600">{total}</span>개의 품목
        </div>
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <input
              ...
              placeholder="품명"
              className="w-28 pl-8 pr-2 py-1.5 border border-gray-200 rounded text-xs focus:ring-1 focus:ring-blue-500 focus:border-blue-500 bg-gray-50"
            />
          </div>
          <div className="relative">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {group.priceHistory.slice(0, 8).map((history, idx) => (
                          ...
                          >
                            ...
                            <span
                              className={`px-1.5 py-0.5 rounded text-[10px] font-medium mr-1.5 ${getTypeColor(
                                history.type
                              )}`}
                            >
