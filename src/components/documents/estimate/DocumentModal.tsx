                        ...
                        <div className="col-span-2 text-xs text-start px-2">
                          <div>
                            ...
                            <p>
                              ...
                              adipisicing elit. Eaque unde architecto tenetur
                              officia libero voluptates, esse error sapiente
                              quidem! Dignissimos, tempore repellendus. Quod
                              architecto cupiditate minima a fugit corrupti
                              culpa!
                            </p>
                          </div>
                        </div>
