...
export default function RnDActionBar({
  ...
  return (
    <div className="flex my-4 gap-4">
      ...
      <div className="flex items-center border-b-2 border-slate-400 w-1/3 max-w-sm py-1 focus-within:border-black">
        <svg
        ...
        <input
          ...
          className="px-2 py-1 w-full focus:outline-none focus:border-none font-semibold text-slate-600"
        />
      </div>
    </div>
  );
