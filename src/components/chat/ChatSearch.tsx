      ...
      <div className="flex-1 overflow-y-auto">
        {searchQuery.length < 2 ? (
          <div className="flex flex-col items-center justify-center h-full text-center p-4">
            ...
            <p className="text-sm text-gray-500">2글자 이상 입력하세요</p>
          </div>
          ...
          <>
            <div className="px-4 py-2 bg-gray-50 text-sm text-gray-500 border-b">
              {total}개의 결과
            </div>
            ...
            {hasMore && (
              <div className="p-4">
                <button
                  onClick={loadMore}
                  disabled={isLoading}
                  className="w-full py-2 text-sm text-blue-600 hover:bg-blue-50 rounded-lg disabled:opacity-50"
                >
                  {isLoading ? "로딩 중..." : "더 보기"}
                </button>
              </div>
