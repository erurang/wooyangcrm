        ...
        >
          ...
          <div className="relative">
            ...
            >
              ...
              <svg className={`w-4 h-4 text-gray-400 transition-transform ${showNotificationMenu ? "rotate-90" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {(["all", "mentions", "none"] as ChatNotificationSetting[]).map((setting) => (
                  ...
                  >
                    <span className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                      currentNotificationSetting === setting ? "border-blue-600" : "border-gray-300"
                    }`}>
                      {currentNotificationSetting === setting && (
          ...
          >
            <svg className="w-5 h-5 text-gray-400" fill={isPinned ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24">
