  ...
  useEffect(() => {
    const fetchDocumentsAndCompany = async () => {
      ...
      try {
        ...
        // 문서가 없다면 상담 정보에서 company_id를 가져옵니다.
        if (documentData && documentData.length > 0) {
          companyId = documentData[0].company_id;
        } else {
          // 'consultation_id'에 해당하는 상담 데이터를 가져와서 company_id를 추출
          ...
          if (consultationError) {
            ...
            companyId = consultationData?.company_id;
          }
        }
