...
export default function PostDetailPage() {
  ...
  return (
    <div className="text-sm text-[#37352F]">
      ...
      {/* 게시글 본문 */}
      <article className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden mb-6">
        {/* 헤더 */}
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1 px-3 py-1.5 text-sm text-slate-500 hover:text-purple-600 hover:bg-purple-50 rounded-md transition-colors"
              >
              ...
              {isAuthor && (
                <>
                  <button
                    onClick={handleEdit}
                    className="flex items-center gap-1 px-3 py-1.5 text-sm text-slate-500 hover:text-sky-600 hover:bg-sky-50 rounded-md transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 text-sm text-slate-500 hover:text-red-600 hover:bg-red-50 rounded-md transition-colors"
                  >
      ...
      <div className="flex justify-center mt-6">
        <button
          onClick={handleBack}
          className="flex items-center gap-2 px-6 py-2.5 text-slate-600 bg-white border border-slate-300 hover:bg-slate-50 rounded-lg transition-colors"
        >
          <ArrowLeft className="w-4 h-4" />
          목록으로
        </button>
