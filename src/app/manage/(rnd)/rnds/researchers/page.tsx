  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">연구인력 현황</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-gray-500">활동 인원</span>
          </div>
          <p className="text-2xl font-bold text-blue-600">{roleSummary.total_active}</p>
        </div>
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center gap-2 mb-1">
            <Briefcase className="w-4 h-4 text-purple-500" />
            <span className="text-xs text-gray-500">책임연구원</span>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-gray-500">공동책임</span>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-gray-500">참여연구원</span>
          </div>
          <p className="text-2xl font-bold text-blue-600">{roleSummary.researcher}</p>
        </div>
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center gap-2 mb-1">
            <Users className="w-4 h-4 text-gray-500" />
            <span className="text-xs text-gray-500">연구보조원</span>
          </div>
          <p className="text-2xl font-bold text-gray-600">{roleSummary.assistant}</p>
        </div>
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center gap-2 mb-1">
      ...
      {totalPersonnelCost > 0 && (
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-gray-600">활동 인력 총 인건비</p>
            ...
            <tbody className="divide-y divide-gray-200">
              {filteredResearchers.length === 0 ? (
                ...
                filteredResearchers.map((researcher) => (
                  <tr
                    key={researcher.id}
                    className={`hover:bg-gray-50 cursor-pointer ${!researcher.is_active ? "opacity-60" : ""}`}
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {researcher.position && (
                            <p className="text-xs text-gray-500">{researcher.position}</p>
                          )}
                        </div>
                      </div>
                    </td>
