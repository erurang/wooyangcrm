    ...
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800">재고 예측 & 발주 권장</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
        <div className="bg-white rounded-xl border p-4">
          <div className="text-sm text-slate-400 mb-1">전체 권장</div>
      ...
      <div className="bg-white rounded-xl border p-4 mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            <label className="block text-xs text-slate-400 mb-1">긴급도</label>
            <select
          ...
          <div>
            <label className="block text-xs text-slate-400 mb-1">제품 유형</label>
            <select
              value={filters.type || ""}
          ...
          <div>
            <label className="block text-xs text-slate-400 mb-1">목표 재고일수</label>
            <select
        ...
        {calculationParams && (
          <div className="mt-3 pt-3 border-t text-xs text-slate-400 flex items-center gap-4">
      ...
      {isLoading && (
        <div className="flex items-center justify-center py-12">
          ...
          <span className="ml-3 text-slate-400">분석 중...</span>
        </div>
      )}
                          ...
                          <td className="py-3 px-4 text-right text-sm text-slate-600">
                            {item.avgDailyConsumption > 0 ? (
                              <>
                                ...
                                <span className="text-slate-400 ml-1">{item.unit}/일</span>
                              </>
                            ) : (
                              ...
                              <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div className="bg-white rounded-lg p-4 border">
                                  ...
                                  <div className="space-y-2 text-sm">
                                    <div className="flex justify-between">
                                      <span className="text-slate-400">총 출고량</span>
                                      <span className="font-medium">
                                        {item.last90DaysOutbound.toLocaleString()} {item.unit}
                                      </span>
                                    </div>
                                    <div className="flex justify-between">
                                      <span className="text-slate-400">일평균 소모</span>
                                      <span className="font-medium">
                                        {item.avgDailyConsumption.toFixed(2)} {item.unit}
                                      </span>
                                    </div>
                                    <div className="flex justify-between">
                                      <span className="text-slate-400">월평균 소모</span>
                                      <span className="font-medium">
                                ...
                                <div className="bg-white rounded-lg p-4 border">
                                  ...
                                  <div className="space-y-2 text-sm">
                                    ...
                                    <div className="flex justify-between">
                                      <span className="text-slate-400">최소 재고</span>
                                      <span className="font-medium">
                                        {item.minStock?.toLocaleString() || "-"} {item.unit}
                                      </span>
                                    </div>
                                    <div className="flex justify-between">
                                      <span className="text-slate-400">소진 예상일</span>
                                      <span
                                        className={`font-medium ${
                                          item.daysUntilStockout !== null &&
                                          item.daysUntilStockout <= 14
